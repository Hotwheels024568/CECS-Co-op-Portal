...
from backend.routers.profiles.companies import router as companies_router
from backend.routers.profiles.employers import router as employers_router
from backend.routers.profiles.faculty import router as faculty_router
from backend.routers.profiles.students import router as students_router
from backend.routers.profiles.relationships import router as relationships_router

from backend.routers.internships.internships import router as internships_router
from backend.routers.internships.applications import router as applications_router
from backend.routers.internships.summaries import router as summaries_router
