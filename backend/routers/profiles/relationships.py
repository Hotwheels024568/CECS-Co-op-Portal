...
from backend.routers.models import Contact, FacultyProfile, StudentProfile
from backend.routers.profiles.faculty import FacultyProfileResponse
...
from database.schema_operations.read import get_faculty, get_faculty_by_id, get_student_by_id
