#!/bin/bash
# Start PostgreSQL DB (Docker), activate Python venv, and run FastAPI app with uvicorn
# Usage: %~nx0 [--help | -h]
...
show_help() {
    ...
    echo "Usage: ${0##*/} [--help | -h]"
    echo
    echo "Starts PostgreSQL DB (Docker), activates Python venv, and runs FastAPI backend."
    echo
}
